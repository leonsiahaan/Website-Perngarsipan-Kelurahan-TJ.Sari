											...
											<table id="add1" class="display table table-striped table-hover" >
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo $nik;?></td>
														<td><?php echo $nama;?></td>
														<td><img src="../dataFoto/sktm/scan_ktp/<?php echo $ktp;?>" width="50" height="50" alt=""></td>
														<td><img src="../dataFoto/sktm/scan_kk/<?php echo $kk;?>" width="50" height="50" alt=""></td>
														<td><img src="../dataFoto/sktm/scan_pbb/<?php echo $pbb;?>" width="50" height="50" alt=""></td>
