								...
								<div class="card-body">
									<div class="row">
											...
											<div class="col-md-6 col-lg-6">		
												...
												<div class="form-group">
													<label>Scan PBB</label>
													<input type="file" name="pbb" class="form-control" size="37" required>
												</div>
											</div>
									</div>
								</div>
...
if(isset($_POST['kirim'])){
	...
	$sebab = $_POST['sebab'];
		...
		$file_ktp =  $_POST['keterangan']."_"."$mt_rand"."sktm".".jpg";
		$nama_kk = isset($_FILES['kk']);
    	$file_kk = $_POST['keterangan']."_"."$mt_rand"."sktm".".jpg";
    	$nama_pbb = isset($_FILES['pbb']);
    	$file_pbb = $_POST['keterangan']."_"."$mt_rand"."sktm".".jpg";

	$sql = "INSERT INTO data_request_sktm (nik,scan_ktp,scan_kk,scan_pbb,keperluan,sebab) VALUES ('$nik','$file_ktp','$file_kk','$file_pbb','$keperluan','$sebab')";
