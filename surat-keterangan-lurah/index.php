...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="main/img/logo.png" width="200" height="60" alt="logo"></a>
                </div>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KELURAHAN TANJUNG SARI</h2>
                ...
                <div class="col-sm-6">
                    <div class="media service-box wow fadeInRight">
                        ...
                        <div class="media-body">
                            <h4 class="media-heading">SENIN - JUMAT</h4>
                            <p>Pagi 08.00 - 12.00 WIB</p>
                            <p>Siang 14.00 - 16.30 WIB</p>
                        </div>
                    </div>
                ...
                <div class="features">
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading">Login / Regiter</h4>
                                <p>Register akun untuk membuat surat permohonan dan login, melalui halaman Login.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> Your Company. Credit by <a target="_blank" href="https://www.instagram.com/fachrishofiyyuddin/" title="Ikuti saya">leonsiahaan</a>
                </div>
                <div class="col-sm-6">
                    <ul class="social-icons">
                        <li><a href="https://www.instagram.com/leonshn/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                        <li><a href="https://web.facebook.com/o.leonshn/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
