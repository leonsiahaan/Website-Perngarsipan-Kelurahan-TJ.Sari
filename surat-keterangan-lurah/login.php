          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo text-center">
                <img src="main/img/logo.png" width="150" height="54" alt="logo">
              </div>
              <h4>LOGIN PEMOHON</h4>
              ...
              <form method="POST" class="pt-3">
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/surat-keterangan-lurah/">BATAL</a>
                </div>
